 ...
 * sub commands.</p>
 * <p>For further nesting, the class can implement {@link org.rundeck.toolbelt.HasSubCommands} and return
 ...
 * </pre></code>
 * <p>
 * This constructs a {@link org.rundeck.toolbelt.Tool} object, with a command "greet" (based on the class name
 * Greet).  "greet" has a "hi" and a "remark" subcommand. The class must have at least
 * one method annotated with {@link org.rundeck.toolbelt.Command @Command}.  The parameters of that
 * method (if any) should be annotated with {@link org.rundeck.toolbelt.Arg @Arg} to define their names.
 * (Alternately, if you compile your java class with {@code -parameters} flag to javac, the parameter names will be
 * introspected.)
 * This will use the {@link org.rundeck.toolbelt.SimpleCommandInput} to parse "--somearg value" for a
 ...
 * </p>
 * <p>
 * Use {@link org.rundeck.toolbelt.ToolBelt#belt(java.lang.String)} to create a builder.
 * </p>
 * <pre><code>
 * ToolBelt.belt()
 *   .defaultHelp()
